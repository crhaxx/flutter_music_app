...
class NikolasPage extends StatefulWidget {
  const NikolasPage({super.key});

  @override
  State<NikolasPage> createState() => _NikolasPageState();
}

class _NikolasPageState extends State<NikolasPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: MyDrawer(),
      body: StreamBuilder(
          stream: playlistDatabase.streamNikolas,
